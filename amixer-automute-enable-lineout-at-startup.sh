...
# 06/oct/2025
# Objective: enable the 'Line Out+Mixer' option in Auto-Mute Mode in amixer or alsamixer (audio)

#set 'Line Out+Speaker' options for Auto-Mute item. The values can be: 'Disabled' 'Speaker Only' 'Line Out+Speaker'
